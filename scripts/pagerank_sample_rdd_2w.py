...
def main():
    ...
    output_path = "gs://pagerank-marah-wiki/results/sample_rdd_2w_results"
    top10_output = "gs://pagerank-marah-wiki/results/top10_sample_rdd_2w"
    iterations = 4
    damping = 0.85
    num_part = 20
...
ranks = spark.read.parquet("gs://pagerank-marah-wiki/results/rdd_results")
...
top10.write.mode("overwrite").parquet("gs://pagerank-marah-wiki/results/top10_rdd")
